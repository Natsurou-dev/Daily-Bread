...
const verseWallpaper = document.getElementById("verse-block-container");
verseWallpaper.style.backgroundImage = `url(${verses[day].image})`;

const dailyVerse = document.getElementById("verse");
dailyVerse.textContent = verses[day].NLT_verse;

const dailyAddress = document.getElementById("address");
